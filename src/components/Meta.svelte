<script>
  export let title = "The Hidden Risks of Sesame Allergies";
...
<svelte:head>
  ...
  <meta property="og:image" content="{url}/assets/social/social-facebook.png" />
  ...
  <meta name="twitter:image:src" content="{url}/assets/social/social-twitter.png" />
